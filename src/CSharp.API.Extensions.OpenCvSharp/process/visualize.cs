    ...
    public static class Visualize
    {
        ...
        public static Mat draw_det_result(DetResult result, Mat image)
        {
            ...
            for (int i = 0; i < result.count; i++)
            {
                ...
                Cv2.PutText(image, YoloOption.lables[result.datas[i].index] + "-" + result.datas[i].score.ToString("0.00"),
        ...
        public static Mat draw_poses(PoseResult pose, Mat img, float visual_thresh = 0.2f, bool with_box = true)
        {
            ...
            for (int i = 0; i < pose.count; ++i)
            {
                ...
                Cv2.PutText(image, YoloOption.lables[pose.datas[i].index] + "-" + pose.datas[i].score.ToString("0.00"),

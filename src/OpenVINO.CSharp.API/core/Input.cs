...
namespace OpenVinoSharp
{
    ...
    public class Input : DisposableOvObject
    {
        ...
        public Input(IntPtr ptr) : this(ptr, false) { }

        internal Input(IntPtr ptr, bool isConstPort) : this(ptr, isConstPort, IntPtr.Zero) { }

        internal Input(IntPtr ptr, bool isConstPort, IntPtr constPortPtr) : base(ptr)
        {
        ...
        /// <summary>
        /// 获取输入端口的元素类型 / Get the element type of this input port
        /// </summary>
        ...
        /// <summary>
        /// 获取输入端口的形状 / Get the shape of this input port
        /// </summary>
        ...
        /// <summary>
        /// 获取输入端口的部分形状（支持动态维度）/ Get the partial shape of this input port (supports dynamic dimensions)
        /// </summary>
        ...
        /// <summary>
        /// 获取输入端口的名称 / Get the name of this input port
        /// </summary>
        ...
        /// <summary>
        /// 获取输入端口任意名称 / Gets any name of this input port.
        /// </summary>
        /// <returns>端口名称 / Port name.</returns>
